...
/**
 * Created by 众云图-1 on 2017/8/21.
 */

public class ChecBoxView extends ViewGroup implements View.OnClickListener{
    ...
    public ChecBoxView(Context context) {
        super(context);
        mContext = context;
    }

    public ChecBoxView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        getAttrs(context, attrs);
    }

    public ChecBoxView(Context context, AttributeSet attrs, int defStyleAttr) {
